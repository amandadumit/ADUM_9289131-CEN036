...
#aqui vamos testar se o valor de a e b são inteiros, usando a função isinstance () e imprimir uma mensagem de confirmação ou de erro
...
# aqui vamos testar se eles são inteiros positivos e menores que 1000 e imprimir mensagens de confirmação ou de erro
